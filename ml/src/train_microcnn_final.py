...
OUT = ROOT / "ml" / "models" / "v3_runs" / "microcnn_final"
OUT.mkdir(parents=True, exist_ok=True)

MODEL_PATH = OUT / "microcnn_final_best.pth"
...
class TinyCNN(nn.Module):
    def __init__(self):
        ...
        self.features = nn.Sequential(
            nn.Conv2d(3, 3, 5, stride=2, padding=2),
            nn.ReLU(),
            nn.MaxPool2d(2),
...
print()
print("=" * 55)
print("FINAL MICROCNN TRAINING COMPLETE")
print("=" * 55)
